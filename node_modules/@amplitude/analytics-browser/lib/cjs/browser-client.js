...
var tracking_methods_1 = require("./attribution/tracking-methods");
...
var AmplitudeBrowser = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 6:
                        ...
                        if (!((0, default_tracking_1.isAttributionTrackingEnabled)(this.config.defaultTracking) &&
                            (0, tracking_methods_1.isUserPropertyAttributionEnabled)(attributionTrackingOptions))) return [3 /*break*/, 8];
                    ...
                    case 20:
                        if (!((0, default_tracking_1.isAttributionTrackingEnabled)(this.config.defaultTracking) &&
                            (0, tracking_methods_1.isEventPropertyAttributionEnabled)(attributionTrackingOptions))) return [3 /*break*/, 22];
                        this.config.loggerProvider.debug('Adding event property attribution plugin');
                        return [4 /*yield*/, this.add((0, plugin_event_property_attribution_browser_1.eventPropertyTrackingPlugin)(attributionTrackingOptions)).promise];
                    case 21:
                        _j.sent();
                        _j.label = 22;
                    case 22:
                        if (!(0, default_tracking_1.isElementInteractionsEnabled)(this.config.autocapture)) return [3 /*break*/, 24];
                    ...
                    case 23:
                        ...
                        _j.label = 24;
                    case 24:
                        if (!(0, default_tracking_1.isFrustrationInteractionsEnabled)(this.config.autocapture)) return [3 /*break*/, 26];
                    ...
                    case 25:
                        ...
                        _j.label = 26;
                    case 26:
                        if (!(0, default_tracking_1.isNetworkTrackingEnabled)(this.config.autocapture)) return [3 /*break*/, 28];
                    ...
                    case 27:
                        ...
                        _j.label = 28;
                    case 28:
                        if (!(0, default_tracking_1.isWebVitalsEnabled)(this.config.autocapture)) return [3 /*break*/, 30];
                    ...
                    case 29:
                        ...
                        _j.label = 30;
                    case 30:
                        if (!(0, default_tracking_1.isPerformanceTrackingEnabled)(this.config.autocapture)) return [3 /*break*/, 32];
                        this.config.loggerProvider.debug('Adding performance tracking plugin');
                        return [4 /*yield*/, this.add((0, plugin_autocapture_browser_1.performancePlugin)((0, default_tracking_1.getPerformanceTrackingConfig)(this.config))).promise];
                    case 31:
                        _j.sent();
                        _j.label = 32;
                    case 32:
                        if (!(0, default_tracking_1.isPageUrlEnrichmentEnabled)(this.config.autocapture)) return [3 /*break*/, 34];
                    ...
                    case 33:
                        ...
                        _j.label = 34;
                    case 34:
                        if (!(0, default_tracking_1.isCustomEnrichmentEnabled)(this.config.customEnrichment)) return [3 /*break*/, 36];
    ...
    AmplitudeBrowser.prototype.trackCampaignEventIfNeeded = function (lastEventId, promises) {
        if (!this.webAttribution ||
            ...
            !(0, tracking_methods_1.isUserPropertyAttributionEnabled)(this.webAttribution.options)) {
            return false;
        }
