                ...
                switch (_j.label) {
                    ...
                    case 6:
                        ...
                        if (!(isAttributionTrackingEnabled(this.config.defaultTracking) &&
                            isUserPropertyAttributionEnabled(attributionTrackingOptions))) return [3 /*break*/, 8];
                    ...
                    case 20:
                        if (!(isAttributionTrackingEnabled(this.config.defaultTracking) &&
                            isEventPropertyAttributionEnabled(attributionTrackingOptions))) return [3 /*break*/, 22];
                        this.config.loggerProvider.debug('Adding event property attribution plugin');
                        return [4 /*yield*/, this.add(eventPropertyTrackingPlugin(attributionTrackingOptions)).promise];
                    case 21:
                        _j.sent();
                        _j.label = 22;
                    case 22:
                        if (!isElementInteractionsEnabled(this.config.autocapture)) return [3 /*break*/, 24];
                    ...
                    case 23:
                        ...
                        _j.label = 24;
                    case 24:
                        if (!isFrustrationInteractionsEnabled(this.config.autocapture)) return [3 /*break*/, 26];
                    ...
                    case 25:
                        ...
                        _j.label = 26;
                    case 26:
                        if (!isNetworkTrackingEnabled(this.config.autocapture)) return [3 /*break*/, 28];
                    ...
                    case 27:
                        ...
                        _j.label = 28;
                    case 28:
                        if (!isWebVitalsEnabled(this.config.autocapture)) return [3 /*break*/, 30];
                    ...
                    case 29:
                        ...
                        _j.label = 30;
                    case 30:
                        if (!isPerformanceTrackingEnabled(this.config.autocapture)) return [3 /*break*/, 32];
                        this.config.loggerProvider.debug('Adding performance tracking plugin');
                        return [4 /*yield*/, this.add(performancePlugin(getPerformanceTrackingConfig(this.config))).promise];
                    case 31:
                        _j.sent();
                        _j.label = 32;
                    case 32:
                        if (!isPageUrlEnrichmentEnabled(this.config.autocapture)) return [3 /*break*/, 34];
                    ...
                    case 33:
                        ...
                        _j.label = 34;
                    case 34:
                        if (!isCustomEnrichmentEnabled(this.config.customEnrichment)) return [3 /*break*/, 36];
