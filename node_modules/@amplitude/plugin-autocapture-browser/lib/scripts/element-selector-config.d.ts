 ...
 * `undefined`.
 */
export declare function subscribeToElementSelectorConfig(config: BrowserConfig, dataExtractor: DataExtractor): (() => void) | undefined;
//# sourceMappingURL=element-selector-config.d.ts.map