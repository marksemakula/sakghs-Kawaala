...
function getSharedSelectorEngine() {
    if (!sharedSelectorEngine) {
        sharedSelectorEngine = (0, element_selector_1.createSelectorEngine)((0, element_selector_1.resolveSelectorConfig)());
    }
...
var DataExtractor = /** @class */ (function () {
    function DataExtractor(options, context) {
        ...
        this.updateSelectorConfig = function (remote, logger) {
            _this.selectorEngine.updateConfig((0, element_selector_1.resolveSelectorConfig)(remote !== null && remote !== void 0 ? remote : undefined, logger));
        };
