  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-24 pb-16 bg-gradient-to-r from-[#800E13] to-[#5C0A0F] overflow-hidden">
        <img src="/GOMBE HIGH SCHOOL - KAWAALA/Students life/Gallery/CLASSES/IMG_9807.JPG" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" loading="eager" />
