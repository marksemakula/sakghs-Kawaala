  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative pt-24 pb-16 bg-gradient-to-r from-[#800E13] to-[#5C0A0F] overflow-hidden">
        <img src="/GOMBE HIGH SCHOOL - KAWAALA/Students life/Gallery/DANCESPORT/_MG_6845.JPG" alt="" className="absolute inset-0 w-full h-full object-cover opacity-20" loading="eager" />
          ...
          <div className="pt-4 pb-2 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-6">
              <div className="flex gap-4 text-sm">
                <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-[#FFD700] transition-colors">Privacy Policy</a>
                <a href="#" onClick={(e) => e.preventDefault()} className="text-gray-400 hover:text-[#FFD700] transition-colors">Terms of Service</a>
              </div>
