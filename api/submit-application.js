...
//
// This deployment is shared with the Bujuuko campus site (same "GES Bujuuko
// Apply Now Handler" Apps Script project) since both campuses notify the same
// two admin addresses and log to the same backup Sheet. The Apps Script emails
// info@ges.ac.ug and info@gombehighschool.ac.ug.
//
...
// the URL below (and in the sakghs-bujuuko repo's copy of this file).

const APPLY_NOW_FORM_URL = 'https://script.google.com/macros/s/AKfycbzmzHFBgf2HCXoy04_Idd1h7bms4lEJBImoTJzvnbjsb0rnvxeBP10q_Os6wQdLFghlVA/exec';
